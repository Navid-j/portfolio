    ...
    items: [
        {
            ...
            text: 'navid.j98@gmail.com',
            href: 'mailto:navid.j98@gmail.com',
        },
        {
...
export const socialLinks: Social[] = [
    { label: 'Github', Icon: GithubIcon, target: '_blank', href: 'https://github.com/Navid-j' },
    { label: 'Stack Overflow', Icon: StackOverflowIcon, target: '_blank', href: 'https://stackoverflow.com/users/5488679/navid-jahangiri' },
    { label: 'LinkedIn', Icon: LinkedInIcon, target: '_blank', href: 'https://www.linkedin.com/in/navid-jahangiri/' },
    { label: 'Instagram', Icon: InstagramIcon, target: '_blank', href: ' ' },
    { label: 'Twitter', Icon: TwitterIcon, target: '_blank', href: ' ' },
];
