        ...
        <Section noPadding sectionId={SectionId.Hero}>
            <div className="relative flex h-screen w-full items-center justify-center">
                ...
                <div className="z-10  max-w-screen-lg px-4 lg:px-0">
                    <div className="flex flex-col items-center gap-y-4 rounded-xl bg-gray-800/40 p-6 text-center shadow-lg backdrop-blur-sm">
                        <div className={classNames({ 'md:grid-cols-4': !!profileImageSrc })}>
                            {!!profileImageSrc && (
